...
#define TASK_5_DURATION         (0.87)
#define TASK_9_DURATION         (1.0)

#define TASK_1_SENSOR_THROSHOLD         (30)
#define TASK_11_SENSOR_THROSHOLD        (35)

#define TASK_3_LENGTH_FRONT         (0.70)
#define TASK_7_LENGTH_FRONT         (0.70)
...
{
  ros::init(argc, argv, "funcase_test_stage");
  ros::NodeHandle node;
