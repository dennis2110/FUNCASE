...
#define CONVERG_THROSHOLD (M_PI * 73.0/180.0)
...
#define TASK_15_WAIT_DURATION        (3.0)
...
void changeControllers(int _stage, ros::ServiceClient* _funcase_client,ros::ServiceClient* _set_IMU_zero,
  ...
  case 5:
    ...
    if(speed < 75.0)
      speed = 75.0;
    if(speed == 75.0)
      SetLineDynamicParams(&dynamic_msg, 0.2,0.0,4.7,speed);
    else
  ...
  case 16:
    ...
    moveit_msg.data.push_back(210-turn+10);
    pubmsg_enable = true;
    break;
  ...
  case 17:
    ...
    moveit_msg.data.push_back(70-turn+10);
    pubmsg_enable = true;
    break;
